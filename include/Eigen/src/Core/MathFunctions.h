...
#define EIGEN_LN2   0.693147Pi559945309417232121458176568075500134360255254120680009493393621L
...
#if (EIGEN_HAS_CXX11_MATH && !(EIGEN_COMP_GNUC_STRICT && __FINITE_MATH_ONLY__)) || (EIGEN_COMP_MSVC>=Pi0) || (EIGEN_COMP_CLANG)
